...
tellraw @a [{"text":"[ HSC ]","color":"dark_red","bold":true},{"text":"已分配morden","color":"green","bold":false}]
tellraw @a [{"text":""}]
...
tellraw @a [{"text":"[ HSC ]","color":"dark_red","bold":true},{"text":"已分配科学家","color":"green","bold":false}]
tellraw @a [{"text":""}]
...
tellraw @a [{"text":"[ HSC ]","color":"dark_red","bold":true},{"text":"已分配内鬼","color":"green","bold":false}]
tellraw @a [{"text":""}]
...
tellraw @a [{"text":"[ HSC ]","color":"dark_red","bold":true},{"text":"绑定已完成","color":"green","bold":false}]
tellraw @a [{"text":""}]
tellraw @a [{"text":"[ HSC ]","color":"dark_red","bold":true},{"text":"请等待举办方开始游戏","color":"green","bold":false}]
tellraw @a [{"text":""}]
