scoreboard objectives add msgtitle dummy "LOixSPC 平行枷锁"
...
scoreboard players set 平行枷锁v0.2.0测试版 msgtitle 2
scoreboard players set 不代表最终品质 msgtitle 1
team add neigui
team join neigui 内鬼人数：4
team modify neigui color dark_red
team add kexuejia 
team join kexuejia 科学家人数：2
team modify kexuejia color dark_blue
